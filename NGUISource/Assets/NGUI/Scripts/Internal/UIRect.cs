...
public abstract class UIRect : MonoBehaviour
{
	...
	public class AnchorPoint
	{
        ...
        //根据给定的abs值，确定该锚点的位置(左，中，右)或(底，中，上)
	...
	public UIRect parent
	{
		get
		{
			...
			{
				mParentFound = true;
                //若父级（一级）和本身都有该组件，则优先返回父级的组件；若父级无该组件，本身有该组件，则返回本身组件。
	...
	/// </summary>
    //矩形需要按指定顺序更新--先父级后子级。当继承该类时，重写OnUpdate()而不是重写Update()。
	public void Update ()
	{
